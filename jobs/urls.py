...
urlpatterns = [
    ...
    path('send-message/',     views.task_create_send_message,    name='task_create_send_message'),
    path('update-profile/',   views.task_create_update_profile,  name='task_create_update_profile'),
    path('view-stories/',     views.task_create_view_stories,    name='task_create_view_stories'),
    path('mark-all-read/',    views.task_create_mark_all_read,   name='task_create_mark_all_read'),
    path('set-2fa-password/', views.task_create_set_2fa_password,name='task_create_set_2fa_password'),
