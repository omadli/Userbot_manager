...
urlpatterns = [
    ...
    path('search/', views.global_search_json, name='global_search'),
    ...
    path('detail/<int:pk>/live-chats/<int:chat_id>/', views.account_chat_detail, name='account_chat_detail'),
    path('detail/<int:pk>/live-chats/<int:chat_id>/poll/', views.account_chat_poll_json, name='account_chat_poll'),
    path('detail/<int:pk>/live-chats/<int:chat_id>/media/<int:msg_id>/', views.account_chat_media, name='account_chat_media'),
